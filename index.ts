...
app.get('/Trabalho', async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  try {
    ...
    const resultado = await conn.query("INSERT INTO clientes (id, nome, sobrenome, empresa) VALUES (?, ?)", [id, nome, sobrenome, empresa])
